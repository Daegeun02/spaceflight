...
def step_2( r_chs_0_ECI, r_trg_t_ECI, t_tof, geometry):
    ...
    theta_0 = arctan2( r_chs_0_ORP[0], r_chs_0_ORP[1] )
    theta_t = arctan2( r_trg_t_ORP[0], r_trg_t_ORP[1] )
    theta   = theta_t - theta_0

    ## define Lambert Problem
    LP = LambertProblem( geometry )
